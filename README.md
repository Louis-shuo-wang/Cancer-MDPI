...
The first outputs is "all_snapshots", which is the tumor and vessel agents, TAF field, oxygen field, TAF field information at four times: (initial_time + max_time)/4:(initial_time + max_time)/4:(initial_time + max_time);
