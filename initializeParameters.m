...
params.grid_size = [200, 200];        % Size of simulation domain
params.dg = 1 ./ params.grid_size;
params.dy = params.dg(1);
params.dx = params.dg(2);
params.Rc = 0.2 * params.dx;         % Cell radius
...
params.dt1 = 0.01;                   % Time scale for molecule diffusion
...
params.Sd = 2;                        % Drug supply rate from vessels  2 critical****
...
% Mutation parameters
params.mutation_rate = 1e-3;             % Probability of mutation during division
...
params.initial_tumor_number = 100;    % Initial tumor cell number   100
params.initial_tip_number = 4;        % Initial tip cell numbeer
